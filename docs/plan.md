...
На входе имеем список объектов и многоугольник с размерами. Размеры даны в см, измеренных на естественной плоскости.
Для каждого объекта заранее посчитаны его размера и контуры.
### Площадь
